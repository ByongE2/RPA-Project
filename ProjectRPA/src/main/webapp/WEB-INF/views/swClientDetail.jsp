		...
		<div class="content_area">
			...
			<div class="content_top">
				<div class="ct_left_area">
					<div class="image_wrap" data-bookid="${swInfo.imageList[0].goods_swID}" data-path="${swInfo.imageList[0].uploadPath}" data-uuid="${swInfo.imageList[0].uuid}" data-filename="${swInfo.imageList[0].fileName}">
						<img>
					</div>				
				</div>
				<div class="ct_right_area">
					...
					<div class="price">
						...
						<div class="discount_price">
							...
							[<fmt:formatNumber value="${goodsInfo.goods_swDiscount*100}" pattern="###" />% 
