...
<div>
	<label>상품내용</label>
	<!-- 
	<textarea rows="30" cols="30"  name="pt_content">${pt_no.PT_content }</textarea> -->
...
<button id="ptmodify">수정하기</button>
<button id="ptremove" value="${pt_no.PT_no }">삭제</button>
<button id="ptlist">리스트</button>

<script>
	$(document).ready(function() {
		$("#ptmodify").on("click",function(){
			self.location ="/ptproduct/ptmodify";
		});
		$("#ptremove").on("click",function(){
			var no=(${pt_no.PT_no });
			self.location="/ptproduct/ptremove";
		});
